...
namespace WebAPI.Mappers
{
    ...
    public class FlightCreationProfile : Profile
    {
        ...
        public FlightCreationProfile(out MapperConfiguration configCreation)
        {

            AuthenticateAndGetFacade(out AnonymousUserFacade facade);

            configCreation = new MapperConfiguration(cfg => cfg.CreateMap<FlightCreationDTO, Flight>()
